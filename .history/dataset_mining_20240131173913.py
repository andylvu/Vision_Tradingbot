...
class DataMining:
    ...
    def tradable(self):
        ...
        if tradable_input is None or tradable_label is None:
    ...
    def label(self):
        ...
        if trend_input is None or trend_label is None:
            print('invalid input, enter valid option')
            return self.label1()
        ...
        if phase_input is None or phase_label is None:
            print('invalid input, enter valid option')
            return self.label1()
        ...
        if after_input is None or after_label is None:
            print('invalid input, enter valid option')
            return self.label1()
